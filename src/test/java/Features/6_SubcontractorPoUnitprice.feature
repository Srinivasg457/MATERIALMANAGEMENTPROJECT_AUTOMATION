...
#
  ...
  @regression
  Scenario: Moving to Subcontractor Unit Price  Module And Get The List of Subcontractor unit price data
    When the user enters their email "Srinivas.g@limitscale.io"
    And the user clicks the Submit button
    Then the user enters their password "Limitscale@05"
    And the user clicks the login button
  ...
  @regression
  Scenario: Moving to Subcontractor Unit Price  Module And Perform The Import Of Data from The Empty Excel Sheet
    When the user enters their email "Srinivas.g@limitscale.io"
    And the user clicks the Submit button
    Then the user enters their password "Limitscale@05"
    And the user clicks the login button
    ...
    And Choose The Empty sheet File for The Bulk upload
    Then Click The Process import Button

  @regression
  Scenario: Moving to Subcontractor Unit Price  Module And Perform The Import Of Data from The Excel Sheet
    When the user enters their email "Srinivas.g@limitscale.io"
    And the user clicks the Submit button
    Then the user enters their password "Limitscale@05"
    And the user clicks the login button
    ...
    And click the Subcontractors Po Unit price sub menu
    Then click the Import button
    And Choose The File With Data for The Bulk upload
    Then Click The Process import Button
