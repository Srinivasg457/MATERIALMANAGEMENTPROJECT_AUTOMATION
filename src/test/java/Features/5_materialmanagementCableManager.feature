...
#    And Click The Cable Inward Sub Menu
...
#
#  @regression
#  Scenario: Moving to Cable Manager Module and getting the List
#    When the user enters their email "Srinivas.g@limitscale.io"
#    And the user clicks the Submit button
#    Then the user enters their password "Limitscale@05"
#    And the user clicks the login button
...
#    And the user verifies that the radio buttons can be selected and deselected
