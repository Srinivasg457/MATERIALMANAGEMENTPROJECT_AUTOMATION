...
#    Then click the master side menu
  ...
  @regression
  Scenario: Moving to Supplier Module And Find The Error Mesage
    When the user enters their email "Srinivas.g@limitscale.io"
    And the user clicks the Submit button
    Then the user enters their password "Limitscale@05"
    And the user clicks the login button
#    Then click the master side menu
  ...
  @regression
  Scenario:  Moving to Suppliers Module And Get The List Of The Suppliers Details In The Table List
    When the user enters their email "Srinivas.g@limitscale.io"
    And the user clicks the Submit button
    Then the user enters their password "Limitscale@05"
    And the user clicks the login button
